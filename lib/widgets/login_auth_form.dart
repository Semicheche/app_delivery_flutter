...
import 'package:delivery_app/services/local_storage/local_storage.dart';
...
class _AuthFormState extends State<AuthForm> {
  ...
  LocalSotrage _sotrage = LocalSotrage();
  ...
  Future<void> getSaveUser()async {
    if ((await _sotrage.getByKey('remember')) != null){
      _authData.email = (await _sotrage.getByKey('email'))!;
      _authData.password = (await _sotrage.getByKey('password'))!;
      _authData.saveCredentials = (await _sotrage.getByKey('remember')) != null;
    }
  }
